...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Sent items</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Messages envoyés</p>
        </div>
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-gray-500 dark:text-gray-400">
                                <span class="inline-flex items-center gap-1">
                                    ...
                                    À: <span class="font-semibold text-gray-700 dark:text-gray-200">
            ...
            @empty
                <div class="p-8 text-center">
                    <div class="text-gray-400 mb-2">
                        <i class="ti ti-send text-4xl"></i>
                    </div>
                    <p class="text-gray-700 dark:text-gray-200 font-semibold">Aucun message envoyé.</p>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Tes messages envoyés apparaîtront ici.</p>
                </div>
            @endforelse
        </div>
