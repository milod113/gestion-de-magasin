...
@section('subtitle', 'Enregistrer un nouvel équipement biomédical avec n° de série')
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-1">
                            Renseignez les informations de l'équipement biomédical pour assurer sa traçabilité
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <div class="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg blur opacity-10 group-hover:opacity-20 transition duration-300"></div>
                            <div class="relative">
                                <span class="absolute left-3 top-3 text-gray-400 dark:text-gray-500">
                                    <i class="fas fa-barcode"></i>
                                </span>
                                <input type="text" name="serial_number" value="{{ old('serial_number') }}"
                                       class="w-full pl-10 pr-4 py-3 rounded-lg border @error('serial_number') border-red-500 dark:border-red-500 @else border-gray-300 dark:border-gray-600 @enderror bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                                       placeholder="ex : SN-2025-000123" required>
                            </div>
                        </div>
                        @error('serial_number')
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            ...
                            Ce numéro doit être unique pour assurer la traçabilité
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="inventory_number" value="{{ old('inventory_number') }}"
                                   class="w-full pl-10 pr-4 py-3 rounded-lg border @error('inventory_number') border-red-500 dark:border-red-500 @else border-gray-300 dark:border-gray-600 @enderror bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                                   placeholder="ex : INV-CHU-00045">
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="label" value="{{ old('label') }}"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                               placeholder="ex : Respirateur Dräger Evita 4">
                        @error('label')
                            <div class="flex items-center text-red-500 text-sm mt-1">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="equipment_category_id"
                                class="w-full px-4 py-3 rounded-lg border @error('equipment_category_id') border-red-500 dark:border-red-500 @else border-gray-300 dark:border-gray-600 @enderror bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="manufacturer" value="{{ old('manufacturer') }}"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                               placeholder="ex : Dräger, GE, Philips...">
                        @error('manufacturer')
                            <div class="flex items-center text-red-500 text-sm mt-1">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="model" value="{{ old('model') }}"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                               placeholder="ex : Evita 4, V60, IntelliVue MX700...">
                        @error('model')
                            <div class="flex items-center text-red-500 text-sm mt-1">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="acquisition_date" value="{{ old('acquisition_date') }}"
                                   class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm">
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="status"
                                class="w-full px-4 py-3 rounded-lg border @error('status') border-red-500 dark:border-red-500 @else border-gray-300 dark:border-gray-600 @enderror bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm">
                            @foreach([
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="notes" rows="4"
                              class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                              placeholder="Informations complémentaires : conditions d'installation, spécificités techniques, historique d'interventions, etc.">{{ old('notes') }}</textarea>
                    @error('notes')
                        <div class="flex items-center text-red-500 text-sm mt-1">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            {{ $message }}
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="text-sm text-gray-500 dark:text-gray-400">
                        <p class="flex items-center">
                            ...
                            Toutes les informations seront vérifiées avant l'enregistrement
                        </p>
                    </div>
                    <div class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
                        ...
                        <button type="submit" 
                            ...
                            <span class="relative z-10">Enregistrer l'équipement</span>
                        </button>
                    </div>
                </div>
            </div>
