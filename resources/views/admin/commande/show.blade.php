...
@section('title', 'Détails de la Commande - ' . $commande->ref_commande)
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-5">
            ...
            <div class="mt-2 flex items-center text-sm text-indigo-100">
                ...
                Créé le {{ $commande->date_commande->format('d/m/Y') }}
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">
                                    {{ $ligne->article->designation ?? 'Article inconnu' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                    {{ $ligne->article_reference }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white">
                                    {{ $ligne->quantité }} unités
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 dark:bg-opacity-20">
                                        Commandé
                                    </span>
                                </td>
                            </tr>
