...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 transition-all duration-300">
    ...
    <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <!-- Articles Section -->
<!-- Items Section (Articles + Equipements) -->
<div class="bg-gradient-to-r from-blue-50/20 via-cyan-50/10 to-emerald-50/20 dark:from-blue-900/5 dark:via-cyan-900/5 dark:to-emerald-900/5 rounded-xl border border-blue-100 dark:border-blue-900/30 p-6">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-3">
            ...
            <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Items reçus</h4>
        </div>
        <span class="px-3 py-1 text-sm font-medium rounded-full bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-800">
            {{ $reception->lignes->count() }} ligne(s)
        </span>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead>
                <tr class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    ...
                    <th class="px-6 py-3 text-left">N° Série</th>
                ...
                @forelse($reception->lignes as $i => $ligne)
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @elseif($isEquipment)
                                <span class="px-3 py-1 text-xs font-medium rounded-full bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-800">
                                    Équipement
                                </span>
                            @else
                                <span class="px-3 py-1 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600">
                                    Inconnu
                                </span>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-8 text-center">
                            <div class="flex flex-col items-center justify-center space-y-3">
                                ...
                                <div>
                                    <p class="text-gray-500 dark:text-gray-400">Aucune ligne</p>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Les items apparaîtront ici</p>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-blue-50/30 via-cyan-50/20 to-emerald-50/30 dark:from-blue-900/5 dark:via-cyan-900/5 dark:to-emerald-900/5 rounded-xl border border-blue-100 dark:border-blue-900/30 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('receptions.pdf', $reception->id_reception) }}"
