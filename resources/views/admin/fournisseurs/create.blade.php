    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Nouveau Fournisseur</h1>
            </div>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Remplissez toutes les informations du fournisseur</p>
        </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="code_fournisseur" name="code_fournisseur" value="{{ old('code_fournisseur') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="sociéte" name="sociéte" value="{{ old('sociéte') }}"
                                class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
                        ...
                        <div>
                            ...
                            <input type="text" id="raison_sociale" name="raison_sociale" value="{{ old('raison_sociale') }}"
                                class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="télephone" name="télephone" value="{{ old('télephone') }}"
                                    class="block w-full pl-10 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
                ...
                <div class="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="n_compte" name="n_compte" value="{{ old('n_compte') }}"
                                class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
